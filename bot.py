...
from config import BOT_TOKEN, ADMIN_ID, TEMP_DIR, LOG_LEVEL
...
async def on_startup(bot: Bot):
    ...
    # Notify admin
    try:
        await bot.send_message(ADMIN_ID, ADMIN_BOT_STARTED, parse_mode="HTML")
...
async def main():
    ...
    # Register routers (order matters — start commands first)
    ...
    try:
        # Drop pending updates on startup so bot doesn't process old messages
